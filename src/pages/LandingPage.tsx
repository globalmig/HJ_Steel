  ...
  return (
    <div className="min-h-screen bg-dark">
      ...
      <nav className="fixed top-0 w-full z-50 glass border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-white/70">
            ...
            <a href="#products" className="hover:text-brand transition-colors">
              제품정보
            </a>
            <a href="#contact" className="hover:text-brand transition-colors">
              문의하기
            </a>
            <a href="/admin" className="px-4 py-2 rounded-full border border-white/10 hover:bg-white/5 transition-all">
              관리자
            </a>
          </div>
        </div>
      ...
      <section className="relative pt-40 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
            <span className="inline-block px-4 py-1.5 rounded-full bg-brand/10 text-brand text-xs font-bold tracking-widest uppercase mb-6 border border-brand/20">Premium Elevator Solutions</span>
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-8 leading-[1.1]">{settings.hero_title}</h1>
            <p className="text-xl text-white/60 mb-10">{settings.hero_subtitle}</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="glass p-8 rounded-2xl">
      ...
      <section id="products" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="glass p-10 md:p-16 rounded-[3rem] border border-white/5">
            <div className="mb-16">
            ...
            <div className="space-y-20">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white/5 p-8 rounded-2xl border border-white/5 space-y-6">
                  <p className="text-white/70 leading-relaxed">
                    최근 건물의 고층화에 따라 엘리베이터 설치에 사용되는 엘리베이터 가이드레일으로 승강기의 인승 및 용도에 따라 다양한 적용이 가능한 엘리베이터 설치 핵심 부품입니다. 엘리베이터
                    편안하고 안전한 운행과 승객의 안전과 밀접한 비상제동장치에 직접적 영향을 미치는 중요한 부품입니다. 5m를 정척으로 생산되며, 최근 다양한 수요에 맞게 길이단척 및 자동화 설비에도
                    적용되어 지속적인 수요가 발생하는 정밀 가공 제품 입니다.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-xs text-white/40">
                        ▶ 최근 자동화 이동 설비 및 자동화 리프트에 적용 되는 정밀 가공 레일으로 수요가 발생하고 있습니다. 설비의 안정적인 이송을 보장함으로써 제품의 수요가 발생하고 있는 정밀가공
                        제품입니다. 다양한 길이와 사양의 레일을 주문생산하여 설비에 적용하고 있습니다.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white/5 p-8 rounded-2xl border border-white/5 space-y-4">
                  <p className="text-white/70 leading-relaxed">
                    공장 자동화 설비 및 공장 호이스트크레인에 적용되는 레일입니다. 형상은 철도레일의 형상에 단중과 사이즈가 축소된 형태로 생산되는 압연 제품 입니다. 각종 이송설비에 적용되며 수요가
                    발생하며, 상기제품은 모두 수입제품으로 각각의 용도에 따라 일본산과 중국산제품으로 10M 정척의 길이로 국내 시장에 유통되고 있습니다. (단 9K는 6M 정척)
                  </p>
                  <div className="inline-block px-4 py-2 rounded-lg bg-brand/10 text-brand font-mono text-sm">취급 규격: 9K, 12K, 15K, 22K, 30K, 37K, 50K, 70K, 100K</div>
                </div>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white/5 p-8 rounded-2xl border border-white/5 space-y-4">
                  <p className="text-white/70 leading-relaxed">
                    일반 구조물을 제작할때 사용하는 일반형강으로 H빔, 앵글, 잔넬, 사각강 등 다양한 형강을 취급하고 있습니다. 일반강재 SS400재를 기본으로 각종 건축 및 설비 구조물을 제작할수 있는
                    일반자재로 다양한 수요가 발생하고 있습니다.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white/5 p-8 rounded-2xl border border-white/5 space-y-4">
                  <p className="text-white/70 leading-relaxed">
                    지하구조물을 설치할때 상판에 설치하는 자재로 하중 및 용도에 따라 잔넬형 복공판과, 빔복공판으로 구분되며 최근에는 특수 기능에 따른 미끄럼방지 복공판등 특수 기능성 복공판을 다양하게
                    취급하고 있습니다.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white/5 p-8 rounded-2xl border border-white/5 space-y-4">
                  <p className="text-white/70 leading-relaxed">
                    광산 지보용 I 형강으로 광산 갱도 지지용 형강, 최근 자동화 이송설비에 다양하게 적용되어 사용되고 있습니다. 국내산 생산이 종료됨에 따라 중국산 제품으로 대체되어 적용 및 사용되고
                    있습니다.
                  </p>
                </div>
              </div>
      ...
      <section id="contact" className="py-24 px-6 bg-brand/5">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="glass p-10 rounded-3xl">
            <form action="https://formspree.io/f/meelpezl" method="POST" className="space-y-6">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-xl font-bold tracking-tighter ">
            ...
            <div className="text-sm text-white/40 ">
              <p>대표자: 임형준 | 사업자등록번호: 251-88-00095</p>
              <p>사업장 주소: 경기도 고양시 일산동구 백석로 175, 706동 402호 (백석동, 백송마을 7단지 아파트)</p>
              <p>이메일: trap4211@naver.com</p>
            </div>
          </div>

          <div className="text-sm text-white/40">© 2024 HJ Steel. All rights reserved.</div>
